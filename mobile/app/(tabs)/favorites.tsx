...
export default function LibraryScreen() {
    ...
    const fetchMyMovies = async () => {
        try {
            ...
            if (res.data?.data?.favorites) {
                setMovies(res.data.data.favorites);
            }
        } catch (_error) {
    ...
    const handleDelete = async (id: number) => {
        ...
        try {
            ...
            Alert.alert("Error", "Could not remove movie from favorites.");
        } finally {
            setDeletingIds(prev => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.subtitle}>{movies.length} Saved Favorites</Text>
            </View>
            ...
            {loading ? (
                ...
                <View style={styles.emptyContainer}>
                    ...
                    <Text style={styles.emptyText}>Liked movies will appear here. Go explore some titles!</Text>
                </View>
            )}
        </SafeAreaView>
    );
