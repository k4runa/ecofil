      ...
      if (response?.type === "success") {
        ...
        if (idToken) {
          ...
          try {
            ...
            console.log("Google Login Error (Silent):", error);
            Alert.alert("Authentication Failed", "Google authentication with our server failed. Please try again.");
          } finally {
            setLoading(false);
          }
        } else {
          ...
          <ScrollView contentContainerStyle={styles.scrollContent}>
            <View style={styles.header}>
              ...
              <Text style={styles.subtitle}>
                Login to join our amazing community and share your cinematic thoughts.
              </Text>
            </View>
